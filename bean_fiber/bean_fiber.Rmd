...
```{r fig.width = 8, fig.height=10, fig.align='center', echo=TRUE, message=FALSE, warning=FALSE, fig.cap="Oligosaccharide content in 282 common bean genotypes by marketclass (A) Raffinose, (B) Stachyose, (C) Verbascose, and (D) total oligosaccharides (= Raff + Stach + Verb)."}
...
```{r fig.width = 8, fig.height=5, fig.align='center', echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Total Dietary Fiber content in 282 common bean genotypes by marketclass"}
##Boxplots by Marketclass: Total Dietary Fiber
source('boxplot.mktclass.R')
plot_grid(p.TDF.mkt, ncol = 2)
```
...
```{r fig.width = 8, fig.height=5, fig.align='center', echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Total Dietary Fiber content in 282 common bean genotypes by race"}
##Boxplots by race: Total Dietary Fiber
source('boxplot.race.R')
plot_grid(p.TDF.race, ncol = 2)
```
