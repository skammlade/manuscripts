...
```{r fig.width = 8, fig.height=4, fig.align='center', echo=FALSE, message=FALSE, warning=FALSE, fig.cap="(A) Boxplot of Entry means by origin and (B) lineplot of entry means by origin showing gxe."}
source('lineplot.gxe.R')
source('boxplot.gxe.origin.R')
plot_grid(p.SDF.origin, p.gxe.SDF, p.SDF.origin, p.gxe.SDF, labels = c("A", "B", "C", "D"), ncol = 2, align="hv")
```
...
source('lineplot.gxe.R')
source('boxplot.gxe.origin.R')
plot_grid(p.Raff.origin, p.gxe.Raff, p.Stach.origin, p.gxe.Stach, p.Verb.origin, p.gxe.Verb, p.TOligos.origin, p.gxe.TOligos, labels = c("A", "B", "C", "D", "E", "F", "G", "H"), ncol = 2, align="hv")
```
...
source('lineplot.gxe.R')
source('boxplot.gxe.origin.R')
plot_grid(p.SDF.origin, p.gxe.SDF, labels = c("A", "B"), ncol = 2, align="hv")
```
...
ANOVA was conducted treating rep as random with rep nested within origin (rep = block).
...
source('lineplot.gxe.R')
source('boxplot.gxe.origin.R')
plot_grid(p.Raff.origin, p.gxe.Raff, labels = c("A", "B"), ncol = 2, align="h")
```
...
source('lineplot.gxe.R')
source('boxplot.gxe.origin.R')
plot_grid(p.Stach.origin, p.gxe.Stach, labels = c("A", "B"), ncol = 2, align="h")
```
...
source('lineplot.gxe.R')
source('boxplot.gxe.origin.R')
plot_grid(p.Verb.origin, p.gxe.Verb, labels = c("A", "B"), ncol = 2, align="h")
```


## -- Total oligosachharides

```{r fig.width = 8, fig.height=4, fig.align='center', echo=FALSE, message=FALSE, warning=FALSE, fig.cap="(A) Boxplot of Entry means by origin and (B) lineplot of entry means by origin showing gxe."}
source('lineplot.gxe.R')
source('boxplot.gxe.origin.R')
plot_grid(p.TOligos.origin, p.gxe.TOligos, labels = c("A", "B"), ncol = 2, align="h")
```
...
source('lineplot.gxe.R')
source('boxplot.gxe.origin.R')
plot_grid(p.IDF.origin, p.gxe.IDF, labels = c("A", "B"), ncol = 2, align="h")
```
...
source('lineplot.gxe.R')
source('boxplot.gxe.origin.R')
plot_grid(p.SDF.origin, p.gxe.SDF, labels = c("A", "B"), ncol = 2, align="h")
```
...
source('lineplot.gxe.R')
source('boxplot.gxe.origin.R')
plot_grid(p.TDF.origin, p.gxe.TDF, labels = c("A", "B"), ncol = 2, align="h")
```
