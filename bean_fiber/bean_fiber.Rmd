...
Statistical analyses, figures, tables, and reporting was completed using
...
One-way analysis of variance was conducted to determine the effect of 1)market class and 2) race on fiber components of the `r nrow(fiber)/2` entries.
