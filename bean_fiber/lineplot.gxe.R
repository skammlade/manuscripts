...
p.gxe.TDF <- p.gxe.TDF  + geom_line(aes(group=Entry)) + geom_point() 

p.gxe.TDF <- p.gxe.TDF + theme(axis.title.y=element_text(size=12),
...
p.gxe.TDF <- p.gxe.TDF + labs(y=NULL, 
                               x=NULL, 
                               title="Total Dietary Fiber")
...
p.gxe.IDF <- p.gxe.IDF  + geom_line(aes(group=Entry)) + geom_point() 

p.gxe.IDF <- p.gxe.IDF + theme(axis.title.y=element_text(size=12),
                               axis.text.y=element_text(family="Helvetica",
                                                        size=12),
                               axis.title.x=element_blank(),
                               legend.text=element_text(size=12), 
...
p.gxe.IDF <- p.gxe.IDF + labs(y=NULL, 
                              x=NULL, 
                              title="Insoluble Dietary Fiber")
...
p.gxe.SDF <- p.gxe.SDF  + geom_line(aes(group=Entry)) + geom_point() 

p.gxe.SDF <- p.gxe.SDF + theme(axis.title.y=element_text(size=12),
                                       axis.text.y=element_text(family="Helvetica",
                                                                size=12),
                                       axis.title.x=element_blank(),
                                       legend.text=element_text(size=12), 
...
p.gxe.Raff <- p.gxe.Raff  + geom_line(aes(group=Entry)) + geom_point() 

p.gxe.Raff <- p.gxe.Raff + theme(axis.title.y=element_text(size=12),
                                 axis.text.y=element_text(family="Helvetica",
                                                          size=12),
                                 axis.title.x=element_blank(),
                                 legend.text=element_text(size=12), 
...
p.gxe.Raff <- p.gxe.Raff + labs(y=NULL, 
                              x=NULL, 
                              title="Raffinose")
...
p.gxe.Stach <- p.gxe.Stach  + geom_line(aes(group=Entry)) + geom_point() 
...
p.gxe.Verb <- p.gxe.Verb  + geom_line(aes(group=Entry)) + geom_point() 
...
p.gxe.TOligos <- p.gxe.TOligos  + geom_line(aes(group=Entry)) + geom_point()
